...
from myshop2.myshop.accounts.models import LoginAttempt, AccountLock, VerificationCode, Customer
...
class LoginSecurityService:
    ...
    def check_security(self):
        ...
        is_rate_limited, rate_limit_msg = self.check_rate_limit_ip()
        if is_rate_limited:
            result.update({
                'allowed': False,
        ...
        tier, failed_count, delay = self.determine_security_tier()
        result['tier'] = tier
        result['delay'] = delay
        ...
        if tier == 1:
            ...
            # Warning with delay
            remaining = SecurityConfig.TIER_2_MAX - failed_count
            result['message'] = (
